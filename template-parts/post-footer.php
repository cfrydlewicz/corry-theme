...
<footer class="post-footer t_slides-up">
  ...
  <section class="follow-container">
    ...
    <ul>
      ...
      <li><a class="i_rss" href="/subscribe-to-corrys-blog-with-rss/" target="_blank">My RSS Feed</a> is the next best way to follow <em>new blog posts</em>. Bookmark it or add it to <a href="https://www.google.com/search?q=rss+feed+reader" target="_blank">your reader app</a>!</li>
