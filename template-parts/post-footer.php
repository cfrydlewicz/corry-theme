...
<footer class="post-footer t_slides-up">
  ...
  <section class="follow-container">
    ...
    <ul>
      ...
      <li>I also share links to <em>new blog posts</em> on <a class="i_mastodon"  href="https://sfba.social/@cfrydlewicz" target="_blank" rel="noreferrer">Mastodon</a>.</li>
      <li>I share <em>all my content</em> and host discussions about it in <a class="i_facebook" href="https://www.facebook.com/groups/4912504758808432/?ref=share" target="_blank" rel="noreferrer" onclick="javascript:_gaq.push(['_trackEvent','outbound-widget','https://www.facebook.com']);">My Facebook Group</a>.</li>
    </ul>
  </section>
