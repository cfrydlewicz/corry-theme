...
<head>
  ...
  <style>/* critical inline CSS 25.06.03 */
*{box-sizing:border-box;max-width:100%}a,abbr,acronym,address,applet,b,big,blockquote,body,caption,cite,code,dd,del,dfn,div,dl,dt,em,fieldset,form,h1,h2,h3,h4,h5,h6,html,iframe,img,ins,kbd,label,legend,li,object,ol,p,pre,q,samp,small,span,strike,strong,sub,sup,table,tbody,td,tfoot,th,thead,tr,tt,ul,var{background-repeat:no-repeat;border:0;font-size:100%;font-style:inherit;font-weight:inherit;margin:0;outline:0;padding:0;vertical-align:baseline}html{scroll-behavior:smooth}body{line-height:1}embed,iframe,img,video{display:block}table{border-collapse:separate;border-spacing:0}caption,td,th{text-align:left;font-weight:400}button{border-width:0;padding:0}blockquote::after,blockquote::before,q::after,q::before{content:none}blockquote,q{quotes:"" ""}.header-nav>button .nav-menu-text,.u_visually-hidden{height:1px;left:-10000px;overflow:hidden;position:absolute;top:auto;width:1px}.f_small{font-size:.875rem!important}.f_smaller{font-size:.75rem!important}.f_smallest{font-size:12px!important}.sp_right_sm{margin-right:.5rem}.sp_right_md{margin-right:1rem}.sp_right_lg{margin-right:1.5rem}.sp_horizontal-padding,.sp_padding{padding-left:16px;padding-right:16px}.sp_padding,.sp_vertical-padding{padding-bottom:16px;padding-top:16px}.separator{margin-left:.375em;margin-right:.375em;opacity:.5}.separator:empty::before{content:'•';font-size:1.125;font-weight:500}@font-face{font-display:swap;font-family:icomoon;font-style:normal;font-weight:400;src:url("assets/fonts/icomoon/icomoon.ttf?byte2f") format("truetype"),url("assets/fonts/icomoon/icomoon.woff?byte2f") format("woff"),url("assets/fonts/icomoon/icomoon.svg?byte2f#icomoon") format("svg")}body{font-family:Montserrat,helvetica,sans-serif;font-size:16px;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;position:relative;text-wrap:balance;text-wrap:pretty}.inner-wrapper{margin-left:auto;margin-right:auto;max-width:1336px;position:relative;width:100%}.total-wrapper{min-height:100vh;position:relative}.site-header{backface-visibility:hidden;left:0;position:fixed;right:0;top:0;z-index:4}.site-header .inner-wrapper{-ms-flex-align:stretch;align-items:stretch;display:-ms-flexbox;display:flex;max-width:1336px;padding-left:0;padding-right:0}.site-header-primary,.site-header-secondary{background-color:#2e3c41}.site-header-primary{background:radial-gradient(ellipse at right top,#2e3c41 0,#253034 100%)}.site-header-primary .inner-wrapper{height:40px}.site-header-secondary{background:linear-gradient(180deg,#171e21,rgba(23,30,33,.75));display:none}.site-header-secondary .inner-wrapper{font-size:.75rem!important;display:-ms-flexbox;display:flex;height:30px;-ms-flex-pack:justify;justify-content:space-between}.site-header-secondary a{-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex;height:100%;min-width:40px;padding:4px 16px}.site-header-secondary .title{overflow-x:hidden;text-overflow:ellipsis;white-space:nowrap}.site-header-secondary .title strong{font-weight:600}.header-logo{-ms-flex-positive:1;flex-grow:1}.header-logo svg{height:150%;max-height:48px}.header-logo a{display:-ms-flexbox;display:flex;height:100%;padding:4px}.header-nav{position:relative}.header-nav ul{display:-ms-flexbox;display:flex;-ms-flex-flow:column wrap;flex-flow:column wrap;height:100%;list-style:none}.header-nav li{margin:0}.header-nav li:not(:last-child){margin:0}.header-nav a{-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex;font-size:.875rem;font-weight:500;padding:0 8px;width:100%}.header-nav>button{border-radius:0;height:40px;padding:0 12px}.header-nav>button:not(:hover):not(:active){background-color:transparent;color:#eaecec}.header-nav>button .nav-menu-icon{font-size:20px;font-weight:700}.header-nav>button .nav-menu-text{font-size:16px;font-weight:200;margin-left:6px}.header-nav>nav{background-color:#253034;max-width:90vw;opacity:0;padding:4px 0;position:absolute;right:-320px;top:40px;transition-duration:.25s;transition-property:opacity,right,visibility;transition-timing-function:ease-in;visibility:hidden;width:320px;z-index:3}.header-nav>nav a{border-color:oklch(46.6% .111 180.5);border-left-color:oklch(90.78% .153 180.5);border-style:solid;border-width:0 0 0 4px;padding:8px 16px}.header-nav>nav a:not(:hover):not(:active){color:#eaecec}.header-nav>nav a:hover{border-left-color:oklch(71.5% .234 40.6)}.header-nav>nav li li a{padding-left:32px}.header-nav[aria-expanded=true]>button:not(:hover):not(:active){background-color:oklch(71.2% .346 336.4);border-color:oklch(51.36% .169 43.84);color:#000101}.header-nav[aria-expanded=true]>nav{opacity:1;right:0;visibility:visible}.header-search .search-container{height:100%}.header-search .search-container label{display:inline-block;padding-bottom:6px;padding-top:6px}.header-search .search-container label:first-of-type{padding-left:8px}.header-search .search-container label:last-of-type{padding-right:8px}.main-columns-wrapper{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;gap:16px;-ms-flex-pack:justify;justify-content:space-between;padding-top:42px}body.archive .main-columns-wrapper,body.search .main-columns-wrapper{padding-top:16px}.main-columns-wrapper>aside,body:not(.wp-singular) .main-columns-wrapper>main{padding-top:16px}.main-columns-wrapper>main{-ms-flex-positive:1;flex-grow:1;max-width:1024px}.main-columns-wrapper>aside{display:none;max-width:240px;width:25%}.main-columns-wrapper>aside.sticky .sidebar-inner{max-height:calc(100vh - $header_height--max - $footer_height);position:sticky;top:90px}.main-columns-wrapper>aside .sidebar-inner{background-color:rgba(0,0,0,.25);border-color:oklch(46.6% .111 180.5);border-style:solid;border-width:1px;border-radius:.5em;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-wrap:wrap;flex-wrap:wrap;padding:16px 16px 32px}.main-columns-wrapper>aside section:not(:last-child){margin-bottom:2rem}.main-columns-wrapper>aside .sidebar_header,.main-columns-wrapper>aside h3{font-size:1.25em;line-height:1.375;font-weight:400;margin-top:1.625em;margin-bottom:.5em}.main-columns-wrapper>aside li{list-style:none}.main-columns-wrapper>aside>:first-child .sidebar_header,.main-columns-wrapper>aside>:first-child h3{margin-top:0}.main-columns-wrapper>aside .sidebar_read-more a::after{content:"\edbb";display:inline-block;font-family:icomoon;font-style:normal;font-variant:normal;font-weight:400;margin-left:.375em;text-transform:none;speak:none}.main-columns-wrapper>aside .wp-block-latest-posts li{margin-bottom:2rem}#shadow{background-color:rgba(0,0,0,0);bottom:0;left:0;pointer-events:none;position:absolute;right:0;top:0;transition-duration:.25s;transition-property:background-color;transition-timing-function:ease-in;visibility:hidden;z-index:2}body.shadow-on{overflow:hidden}body.shadow-on footer,body.shadow-on main{filter:blur(2px)}body.shadow-on #shadow{background-color:rgba(0,0,0,.5);cursor:pointer;pointer-events:all;visibility:visible}.listing-page-header{padding-top:58px;width:100%}.listing-page-header .page-title{font-size:1.25rem!important}.listing-page-header .page-title:not(:last-child){margin-bottom:.25em}.listing-page-header .page-title span{font-size:12px!important;color:#979ea0;display:block;font-family:monospace;margin-bottom:.125em}.listing-page-header .page-title strong{display:block;font-weight:500}.listing-page-header p{font-size:.75rem!important}body.error404 .main-columns-wrapper{padding-bottom:48px}body.error404 .site-footer{bottom:0;position:absolute;width:100%}.article-card{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;position:relative}@media only screen and (pointer:fine){.main-columns-wrapper>aside .sidebar-inner{background-color:rgba(0,0,0,.5);opacity:.5;transition-duration:.2s;transition-property:opacity}.main-columns-wrapper>aside .sidebar-inner:hover{opacity:1}}@media only screen and (min-width:375px){body{overflow-x:hidden}}@media only screen and (min-width:412px){.header-logo a{padding-left:16px;padding-right:16px}.header-search .search-container label:first-of-type{padding-left:16px}.header-search .search-container label:last-of-type{padding-right:16px}}@media only screen and (min-width:480px){.header-nav a{font-size:1rem;padding:0 16px}}@media only screen and (min-width:1024px){.sp_horizontal-padding,.sp_padding{padding-left:24px;padding-right:24px}.sp_padding,.sp_vertical-padding{padding-bottom:24px;padding-top:24px}body{font-size:18px}.inner-wrapper--at-lg{margin-left:auto;margin-right:auto;max-width:1336px;position:relative;width:100%}.site-header-secondary a{padding-left:24px;padding-right:24px}.header-logo a{padding-left:24px;padding-right:24px}.header-nav a{padding:0 24px}.header-search .search-container label:first-of-type{padding-left:24px}.header-search .search-container label:last-of-type{padding-right:24px}}@media only screen and (min-width:1072px){.main-columns-wrapper{gap:24px;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:nowrap;flex-wrap:nowrap}.main-columns-wrapper>aside{display:initial}}
  </style>
        ...
        <?php if ( is_page_template( 'page_campaign-template.php' ) ) : ?>
          ...
          <section class="header-logo">
            <a href="/" title="Go to the top of the homepage." role="link">
              ...
              <?php if ( is_home() ) : ?><h1 class="logo-supplement-header"><?php else : ?><div class="logo-supplement-header"><?php endif; ?>
                <span class="u_visually-hidden">Corry Frydlewicz</span> for Emeryville<span class="u_visually-hidden"> City Council</span>
