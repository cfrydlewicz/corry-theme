  <footer class="pre-footer inner-wrapper">
    <section class="follow-container sp_horizontal padding" role="complementary">
      ...
      <ul>
        ...
        <li><a class="i_bluesky" href="/bluesky" rel="noreferrer" target="_blank" onclick="javascript:_gaq.push(['_trackEvent','outbound-widget','https://bsky.app']);">Bluesky</a> works too.</li>
